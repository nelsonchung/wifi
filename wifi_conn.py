...
SEEKED_SSID = sys.argv[1] 
print "We want to connect AP named ", SEEKED_SSID 
#if not sys.argv[2]:
if sys.argv[2]:
    SEEKED_PASSPHRASE = sys.argv[2]
    print "password is ", SEEKED_PASSPHRASE 
else:
    SEEKED_PASSPHRASE = ""
    print "password is ", SEEKED_PASSPHRASE 
...
if __name__ == "__main__":
    ...
    if SEEKED_PASSPHRASE:
        print "NelsonDBG enter SEEKED_PASSPHRASE"
        connection_params = {
            "802-11-wireless": {
